...
<<<<<<< HEAD
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($laporan->status_riwayat_id == 1)
                                                    <button type="button"
                                                        class="btn btn-warning">{{ $laporan->statusRiwayat->nama_status }}</button>
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Laporan
                                                                Masuk<small>({{ $laporan->KategoriLaporan->nama_kategori }})</small>
                                                            </h5>
    ...
    <script>
        ...
        function updatePost() {
            const socket = new WebSocket(`ws://172.16.104.37:6001/rlt/laporan?appKey=EDKNGKServer`);
            socket.onopen = function(event) {
                console.log('on open!!');
